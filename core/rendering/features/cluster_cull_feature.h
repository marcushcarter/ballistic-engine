...
{    
    ...
    RenderGraph::Pass prefix_sum_pass;
    ...
    RenderGraph::Pass prefix_sum_pass_2;
    ...
    drivers::DeviceDriverVulkan::Pipeline prefix_sum_pipe;
    ...
    void _create_prefix_sum_2_pass();
